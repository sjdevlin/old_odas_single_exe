    ...
    void threads_multiple_stop(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+                     
                ...
                thread_stop(aobjs->acon_hops_mics_raw_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_mapping_mics_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     

                thread_stop(aobjs->acon_hops_mics_map_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_resample_mics_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     

                thread_stop(aobjs->acon_hops_mics_rs_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_stft_mics_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     

                thread_stop(aobjs->acon_spectra_mics_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_noise_mics_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     

                thread_stop(aobjs->acon_powers_mics_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_ssl_object->thread);

            // +------------------------------------------------------+
            // | Sinks                                                |
            // +------------------------------------------------------+                      

                thread_stop(aobjs->asnk_pots_ssl_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     

                thread_stop(aobjs->acon_pots_ssl_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+                  
                ...
                thread_stop(aobjs->ainj_targets_sst_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                  

                thread_stop(aobjs->acon_targets_sst_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_sst_object->thread);

            // +------------------------------------------------------+
            // | Sinks                                                |
            // +------------------------------------------------------+                      

                thread_stop(aobjs->asnk_tracks_sst_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     

                thread_stop(aobjs->acon_tracks_sst_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_sss_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     

                thread_stop(aobjs->acon_spectra_seps_object->thread);
                thread_stop(aobjs->acon_spectra_pfs_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_istft_seps_object->thread);
                thread_stop(aobjs->amod_istft_pfs_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+  

                thread_stop(aobjs->acon_hops_seps_object->thread);
                thread_stop(aobjs->acon_hops_pfs_object->thread);
        ...
        // +------------------------------------------------------+  
            ...
            // +--------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_resample_seps_object->thread);
                thread_stop(aobjs->amod_resample_pfs_object->thread);

            // +--------------------------------------------------+
            // | Connector                                        |
            // +--------------------------------------------------+  

                thread_stop(aobjs->acon_hops_seps_rs_object->thread);
                thread_stop(aobjs->acon_hops_pfs_rs_object->thread);
        ...
        // +------------------------------------------------------+  
            ...
            // +--------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_volume_seps_object->thread);
                thread_stop(aobjs->amod_volume_pfs_object->thread);

            // +--------------------------------------------------+
            // | Sinks                                            |
            // +--------------------------------------------------+                     

                thread_stop(aobjs->asnk_hops_seps_vol_object->thread);
                thread_stop(aobjs->asnk_hops_pfs_vol_object->thread);

            // +--------------------------------------------------+
            // | Connector                                        |
            // +--------------------------------------------------+  

                thread_stop(aobjs->acon_hops_seps_vol_object->thread);
                thread_stop(aobjs->acon_hops_pfs_vol_object->thread);
        ...
        // +------------------------------------------------------+  
            ...
            // +--------------------------------------------------+  
                ...
                thread_stop(aobjs->amod_classify_object->thread);

            // +--------------------------------------------------+
            // | Sink                                             |
            // +--------------------------------------------------+  

                thread_stop(aobjs->asnk_categories_object->thread);

            // +--------------------------------------------------+
            // | Connector                                        |
            // +--------------------------------------------------+  

                thread_stop(aobjs->acon_categories_object->thread);
